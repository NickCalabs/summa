...
--> statement-breakpoint
ALTER TABLE "portfolio_snapshots" ADD COLUMN "investable_total" numeric(20, 2);--> statement-breakpoint
...
CREATE UNIQUE INDEX "simplefin_account_connection_unique" ON "simplefin_accounts" USING btree ("connection_id","simplefin_account_id");